...
public interface CalloutFormat extends office._IMsoDispObj {
  ...
  @VTID(16)
  office.MsoCalloutAngleType getAngle();
  ...
  @VTID(18)
  office.MsoTriState getAutoAttach();
  ...
  @VTID(20)
  office.MsoTriState getAutoLength();
  ...
  @VTID(24)
  office.MsoCalloutDropType getDropType();
