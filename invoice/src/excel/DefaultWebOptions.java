...
public interface DefaultWebOptions extends Com4jObject {
  ...
  @VTID(30)
  office.MsoScreenSize getScreenSize();
   ...
   * </p>
   * @param rhs Mandatory office.MsoScreenSize parameter.
   */

  @DISPID(1909) //= 0x775. The runtime will prefer the VTID if present
  @VTID(31)
  void setScreenSize(
    office.MsoScreenSize rhs);
  ...
  @VTID(36)
  office.MsoEncoding getEncoding();
   ...
   * </p>
   * @param rhs Mandatory office.MsoEncoding parameter.
   */

  @DISPID(1822) //= 0x71e. The runtime will prefer the VTID if present
  @VTID(37)
  void setEncoding(
    office.MsoEncoding rhs);
  ...
  @VTID(42)
  office.MsoTargetBrowser getTargetBrowser();
   ...
   * </p>
   * @param rhs Mandatory office.MsoTargetBrowser parameter.
   */

  @DISPID(2179) //= 0x883. The runtime will prefer the VTID if present
  @VTID(43)
  void setTargetBrowser(
    office.MsoTargetBrowser rhs);
