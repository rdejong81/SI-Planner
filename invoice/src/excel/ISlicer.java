...
public interface ISlicer extends Com4jObject {
  ...
  @VTID(34)
  excel.SlicerCache getSlicerCache();
  ...
  @VTID(35)
  excel.SlicerCacheLevel getSlicerCacheLevel();
   ...
   * </p>
   * @return  Returns a value of type excel.SlicerItem
   */

  @VTID(42)
  excel.SlicerItem getActiveItem();
