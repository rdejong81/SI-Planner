...
public interface ISpellingOptions extends Com4jObject {
  ...
  @VTID(24)
  void setKoreanUseAutoChangeList(
    boolean rhs);
   ...
   * </p>
   * @return  Returns a value of type excel.XlHebrewModes
   */

  @VTID(27)
  excel.XlHebrewModes getHebrewModes();
   ...
   * </p>
   * @param rhs Mandatory excel.XlHebrewModes parameter.
   */

  @VTID(28)
  void setHebrewModes(
    excel.XlHebrewModes rhs);
   ...
   * </p>
   * @return  Returns a value of type excel.XlArabicModes
   */

  @VTID(29)
  excel.XlArabicModes getArabicModes();
   ...
   * </p>
   * @param rhs Mandatory excel.XlArabicModes parameter.
   */

  @VTID(30)
  void setArabicModes(
    excel.XlArabicModes rhs);
  ...
  @VTID(36)
  void setArabicStrictTaaMarboota(
    boolean rhs);
   ...
   * </p>
   * @return  Returns a value of type excel.XlSpanishModes
   */

  @VTID(39)
  excel.XlSpanishModes getSpanishModes();
   ...
   * </p>
   * @param rhs Mandatory excel.XlSpanishModes parameter.
   */

  @VTID(40)
  void setSpanishModes(
    excel.XlSpanishModes rhs);
   ...
   * </p>
   * @return  Returns a value of type excel.XlPortugueseReform
   */

  @VTID(41)
  excel.XlPortugueseReform getPortugalReform();
   ...
   * </p>
   * @param rhs Mandatory excel.XlPortugueseReform parameter.
   */

  @VTID(42)
  void setPortugalReform(
    excel.XlPortugueseReform rhs);
  ...
  @VTID(43)
  excel.XlPortugueseReform getBrazilReform();
