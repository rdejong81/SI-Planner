...
public interface IStyle extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type excel.XlOrientation
   */

  @VTID(45)
  excel.XlOrientation getOrientation();
   ...
   * </p>
   * @param rhs Mandatory excel.XlOrientation parameter.
   */

  @VTID(46)
  void setOrientation(
    excel.XlOrientation rhs);
