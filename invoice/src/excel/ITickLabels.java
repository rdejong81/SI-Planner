...
public interface ITickLabels extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type excel.XlTickLabelOrientation
   */

  @VTID(19)
  excel.XlTickLabelOrientation getOrientation();
   ...
   * </p>
   * @param rhs Mandatory excel.XlTickLabelOrientation parameter.
   */

  @VTID(20)
  void setOrientation(
    excel.XlTickLabelOrientation rhs);
