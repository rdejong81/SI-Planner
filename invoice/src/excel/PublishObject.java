...
public interface PublishObject extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type excel.XlSourceType
   */

  @DISPID(685) //= 0x2ad. The runtime will prefer the VTID if present
  @VTID(14)
  excel.XlSourceType getSourceType();
   ...
   * </p>
   * @return  Returns a value of type excel.XlHtmlType
   */

  @DISPID(1893) //= 0x765. The runtime will prefer the VTID if present
  @VTID(16)
  excel.XlHtmlType getHtmlType();
   ...
   * </p>
   * @param rhs Mandatory excel.XlHtmlType parameter.
   */

  @DISPID(1893) //= 0x765. The runtime will prefer the VTID if present
  @VTID(17)
  void setHtmlType(
    excel.XlHtmlType rhs);
