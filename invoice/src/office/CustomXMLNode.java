...
public interface CustomXMLNode extends office._IMsoDispObj {
  ...
  @VTID(10)
  office.CustomXMLNodes getAttributes();


  @VTID(10)
  @ReturnValue(defaultPropertyThrough={office.CustomXMLNodes.class})
  office.CustomXMLNode getAttributes(
    int index);
  ...
  @VTID(12)
  office.CustomXMLNodes getChildNodes();


  @VTID(12)
  @ReturnValue(defaultPropertyThrough={office.CustomXMLNodes.class})
  office.CustomXMLNode getChildNodes(
    int index);
  ...
  @VTID(13)
  office.CustomXMLNode getFirstChild();
  ...
  @VTID(14)
  office.CustomXMLNode getLastChild();
  ...
  @VTID(16)
  office.CustomXMLNode getNextSibling();
  ...
  @VTID(17)
  office.MsoCustomXMLNodeType getNodeType();
  ...
  @VTID(21)
  office._CustomXMLPart getOwnerPart();
  ...
  @VTID(22)
  office.CustomXMLNode getPreviousSibling();
  ...
  @VTID(23)
  office.CustomXMLNode getParentNode();
