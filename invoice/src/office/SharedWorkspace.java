...
public interface SharedWorkspace extends office._IMsoDispObj {
  ...
  @VTID(11)
  office.SharedWorkspaceMembers getMembers();


  @VTID(11)
  @ReturnValue(defaultPropertyThrough={office.SharedWorkspaceMembers.class})
  office.SharedWorkspaceMember getMembers(
    int index);
  ...
  @VTID(12)
  office.SharedWorkspaceTasks getTasks();


  @VTID(12)
  @ReturnValue(defaultPropertyThrough={office.SharedWorkspaceTasks.class})
  office.SharedWorkspaceTask getTasks(
    int index);
  ...
  @VTID(13)
  office.SharedWorkspaceFiles getFiles();


  @VTID(13)
  @ReturnValue(defaultPropertyThrough={office.SharedWorkspaceFiles.class})
  office.SharedWorkspaceFile getFiles(
    int index);
  ...
  @VTID(14)
  office.SharedWorkspaceFolders getFolders();


  @VTID(14)
  @ReturnValue(defaultPropertyThrough={office.SharedWorkspaceFolders.class})
  office.SharedWorkspaceFolder getFolders(
    int index);
  ...
  @VTID(15)
  office.SharedWorkspaceLinks getLinks();


  @VTID(15)
  @ReturnValue(defaultPropertyThrough={office.SharedWorkspaceLinks.class})
  office.SharedWorkspaceLink getLinks(
    int index);
