...
public interface SharedWorkspaceTask extends office._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type office.MsoSharedWorkspaceTaskStatus
   */

  @DISPID(2) //= 0x2. The runtime will prefer the VTID if present
  @VTID(13)
  office.MsoSharedWorkspaceTaskStatus getStatus();
   ...
   * </p>
   * @param status Mandatory office.MsoSharedWorkspaceTaskStatus parameter.
   */

  @DISPID(2) //= 0x2. The runtime will prefer the VTID if present
  @VTID(14)
  void setStatus(
    office.MsoSharedWorkspaceTaskStatus status);
   ...
   * </p>
   * @return  Returns a value of type office.MsoSharedWorkspaceTaskPriority
   */

  @DISPID(3) //= 0x3. The runtime will prefer the VTID if present
  @VTID(15)
  office.MsoSharedWorkspaceTaskPriority getPriority();
   ...
   * </p>
   * @param priority Mandatory office.MsoSharedWorkspaceTaskPriority parameter.
   */

  @DISPID(3) //= 0x3. The runtime will prefer the VTID if present
  @VTID(16)
  void setPriority(
    office.MsoSharedWorkspaceTaskPriority priority);
