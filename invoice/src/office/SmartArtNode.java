...
public interface SmartArtNode extends office._IMsoDispObj {
  ...
  @VTID(14)
  office.MsoOrgChartLayoutType getOrgChartLayout();
  ...
  @VTID(23)
  office.SmartArtNode getParentNode();
  ...
  @VTID(24)
  office.MsoSmartArtNodeType getType();
