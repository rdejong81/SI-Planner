...
public interface _CustomXMLPart extends office._IMsoDispObj {
  ...
  @VTID(10)
  office.CustomXMLNode getDocumentElement();
  ...
  @VTID(13)
  office._CustomXMLSchemaCollection getSchemaCollection();
  ...
  @VTID(15)
  office.CustomXMLPrefixMappings getNamespaceManager();


  @VTID(15)
  @ReturnValue(defaultPropertyThrough={office.CustomXMLPrefixMappings.class})
  office.CustomXMLPrefixMapping getNamespaceManager(
  ...
  @VTID(23)
  office.CustomXMLValidationErrors getErrors();


  @VTID(23)
  @ReturnValue(defaultPropertyThrough={office.CustomXMLValidationErrors.class})
  office.CustomXMLValidationError getErrors(
    int index);
