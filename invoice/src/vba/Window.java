...
public interface Window extends Com4jObject {
  ...
  @VTID(21)
  vba.vbext_WindowState getWindowState();
  ...
  @VTID(26)
  vba._LinkedWindows getLinkedWindows();
  ...
  @VTID(27)
  vba.Window getLinkedWindowFrame();
