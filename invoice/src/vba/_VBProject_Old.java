...
public interface _VBProject_Old extends vba._ProjectTemplate {
  ...
  @VTID(21)
  vba.vbext_ProjectProtection getProtection();
  ...
  @VTID(23)
  vba._VBComponents getVBComponents();
